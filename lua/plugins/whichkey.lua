...
return {
  {
    ...
    config = function()
      ...
      wk.add {
        { '<leader>p', group = 'picker', icon = { icon = '\u{f0b4e}', color = 'blue' } },                        -- nf-md spyglass (U+F0B4E)
        { '<leader>pf', desc = 'Find files', icon = { icon = '\u{f021e}', color = 'blue' } },                    -- nf-md-file_find
        { '<leader>ps', desc = 'Search in files', icon = { icon = '\u{f13b8}', color = 'blue' } },               -- nf-md-text_search
        { '<leader>pn', desc = 'Messages log', icon = { icon = '\u{f09a2}', color = 'yellow' } },                -- nf-md-bell_ring
        { '<leader>pb', desc = 'Buffers', icon = { icon = '\u{f0219}', color = 'cyan' } },                        -- nf-md-file_document
        ...
        { '<leader>tc', desc = 'Claude split bottom', icon = { icon = '\u{f06d7}', color = 'purple' } },   -- nf-md-robot
        { '<leader>tx', desc = 'Claude split right', icon = { icon = '\u{f06d7}', color = 'purple' } },    -- nf-md-robot
        { '<leader>tp', desc = 'OMP split bottom', icon = { icon = '\u{f0729}', color = 'green' } },       -- nf-md-pi
